                                 ...
                                 const char* fragment_file_path)
{
    ...
    // We check if 'info_log_length' is larger than 1, becase on Emscripten this
    // variable get the value 1 when the shader is complied successfully.
    // Howerver, maybe it should return 0
